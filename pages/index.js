          ...
          <div className="max-w-6xl flex flex-col md:flex-row justify-between mx-auto text-white pt-2 pb-12 px-4 xl:px-0">
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="w-full lg:col-span-7 relative z-10">
                ...
                United Nations Recognised digital tools and become part of
                the Emergency Reserve Cadre.
                </p>
            ...
            <div className="border rounded-lg bg-gradient-to-br from-secondary-700 to-secondary-900 border-secondary-700">
              ...
              <div className="space-y-6 lg:space-y-8 text-base lg:text-lg p-4 lg:p-6">
                ...
                <div className="flex">
                  <span className="text-secondary-400 text-xl">&#10142;</span>
                  <p className="pl-3">
                  Hands-on training in United Nations recognised digital tools for{" "}
                ...
                <div className="lg:col-span-7 2xl:col-span-8">
                  ...
                  <div className="space-y-6 md:space-y-12 md:pr-12 pt-4 md:pt-10 ml-4 lg:ml-24 2xl:ml-44">
                    <div>
                      ...
                      disaster management to use digital tools.
                      </p>
                    </div>
                    <div>
                      <h3 className="heading-with-underscore text-xl lg:text-2xl text-secondary-300 font-medium">
                      ...
                      empowered to both help themselves and can also volunteer 
                      to help society recover faster during a disaster.  
                      </p>
                    </div>
                    <div>
                      <h3 className="heading-with-underscore text-xl lg:text-2xl text-secondary-300 font-medium">
                      ...
                      <p className="ml-8 pt-2 text-sm lg:text-lg text-secondary-50">
                      Age 18+ students who have a desire to serve the nation during emergencies.
                       Prior experience in volunteering via NSS, NCC, NGOs, or teamwork via University/College 
                    ...
                    <div>
                      ...
                      <p className="ml-8 pt-2 text-sm lg:text-lg text-secondary-50">
                      Weekly Ask Me Anything Sessions with experts from the World Health 
                      Organisation and Healthcare workers from the field.
                      </p>
                    </div>
                    <div>
                      <h3 className="heading-with-underscore text-xl lg:text-2xl text-secondary-300 font-medium">
                    ...
                    <div>
                      ...
                      <p className="ml-8 pt-2 text-sm lg:text-lg text-secondary-50">
                      The admissions are on a rolling basis and
                       might close earlier if the seats are filled for the batch.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="border-l border-secondary-800 mx-4 xl:mx-0">
              ...
              <div className="max-w-4xl mx-auto text-secondary-50">
                <div className="pt-8 pb-20 space-y-12 md:space-y-20">
                  ...
                  It has been a truly invaluable learning experience and has learnt from all the
                   constructive input and guidance throughout the course. The course is designed in
                    a manner that learning is not limited. The videos are fabulous and just the right length. 
                    <br></br>- Reema Shaji ( 2nd Year, Computer Science
                    Engineering Student)
                  </blockquote>
                  <blockquote className="testimonial-blockquote pl-12 lg:pl-16">
                  Community Response Network was a splendid course by CoronaSafe Network's 
                  knowledge base. The course was easily accessible and step by step procedures
                  was included in it. After going through the course I got an idea of how our 
                  system manages such a pandemic and what are the responsibilities I have. 
                  platform
                    <br></br>- Asna P (3rd Year, BTech Civil , Government
                    Engineering College Thrissur)
                  </blockquote>
                  <blockquote className="testimonial-blockquote pl-12 lg:pl-16">
                  CRN 101 was a great program. The sessions conducted in this program 
                  helped us to gain so much information. The question and answer session 
                  was fun and informative and we got to know each other. Lastly, the interactive
                  session was also great. 
                        ...
                        <div className="pl-3">
                          <div className="text-secondary-50 space-y-6 text-base lg:text-lg">                
                            <p>
                              ...
                              become part of Emergency Reserve Cadre of thier state.
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="max-w-4xl mx-auto pl-4 lg:pl-0">
                <div className="space-y-12 max-w-3xl py-10 lg:py-20">
                  <div>
                    ...
                    Community Response Network (CRN 101)  is a simple course designed to 
                    give a student a basic understanding of disaster management and how government 
                    systems work in general. 
                    </p>
                    <p className="text-secondary-50 lg:text-lg pt-2">
                    You shall also get training in operating the real software tools that health 
                    force workers use in the field during disaster management.
                    </p>
                  </div>
                  <div>
                  <h4 className="text-primary-500 text-xl lg:text-3xl font-bold">
                  Ask Me Anything (AMA) with WHO experts, Doctors and Field Healthcare workers
                    ...
                    <p className="text-secondary-50 lg:text-lg pt-2">
                    You will hear experience reports from people in the field who managed 
                    Coronavirus since March 2020. There will be no long, boring introductions; 
                    instead, you will hear raw stories from the field, what are the key challenges 
                    and how Covid19 management is taking place. 
                    </p>
                    <p className="text-secondary-50 lg:text-lg pt-2">
                    The best things about these AMAs are the free-wheeling question and answer
                     session where you talk with the speakers about the most pressing questions in your mind.
                    </p>
                    </div>
                  <div>
                    <h4 className="text-primary-500 text-xl lg:text-3xl  font-bold">
                    ...
                    You will have access to a community forum for discussion. There will be a kind and respectful code of conduct to make the experience welcoming for everyone.
                    </p>
                  </div>
                  <div className="space-y-12">
                    <div>
                      ...
                      <div>
                        ...
                        Your mission is to learn how our nation manages a disaster so that 
                        when the next disaster strikes, you already know whom to reach out 
                        to for help and/or can contribute to strengthening the capabilities
                    ...
                    <div>
                      ...
                      <p className="pt-2 text-white">
                        ...
                        called upon to do so; As part of the Emergency Reserve Cadre,
                        you shall have the basic training and skills to be in service 
                        of the nation and ready to serve your state or district administration, 
